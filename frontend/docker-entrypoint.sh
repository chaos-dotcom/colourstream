...
window.RUNTIME_CONFIG = {
  ...
  TURN_SERVER_URL: "${VITE_TURN_SERVER_URL}",
  TURN_SERVER_USERNAME: "${VITE_TURN_SERVER_USERNAME}",
  TURN_SERVER_CREDENTIAL: "${VITE_TURN_SERVER_CREDENTIAL}",
  NAMEFORUPLOADCOMPLETION: "${VITE_NAMEFORUPLOADCOMPLETION}",
  S3_PUBLIC_ENDPOINT: "${VITE_S3_PUBLIC_ENDPOINT}",

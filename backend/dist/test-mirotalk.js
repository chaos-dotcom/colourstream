...
async function generateMiroTalkToken(payload) {
    try {
...
async function createMiroTalkMeeting() {
    try {
        const response = await (0, node_fetch_1.default)('https://video.colourstream.johnrogerscolour.co.uk/api/v1/meeting', {
            method: 'POST',
            headers: {
...
async function joinMiroTalkMeeting(roomId, token, isPresenter = true) {
    try {
